...
PRIVATE int read_header(int fd, int *ft, vir_bytes *text_bytes, 
	vir_bytes *data_bytes, vir_bytes *bss_bytes, 
	phys_bytes *tot_bytes, vir_clicks sc);
PRIVATE int new_mem(vir_bytes text_bytes, vir_bytes data_bytes, 
	vir_bytes bss_bytes, vir_bytes stk_bytes, phys_bytes tot_bytes, 
	char *bf, int zs);
PRIVATE patch_ptr(char *stack, vir_bytes base);
PRIVATE load_seg(int fd, int seg, vir_bytes seg_bytes);
