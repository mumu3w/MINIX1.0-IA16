...
{
	int i, status = 0;
  uint rootino, devino, binino, etcino;
  ...
  devino = creat_dir(rootino, "dev");
	etcino = creat_dir(rootino, "etc");
  
  creat_file(devino, "fd0", 'b', 2, 0);
  creat_file(devino, "fd1", 'b', 2, 1);
	creat_file(devino, "hd0", 'b', 3, 0);
  creat_file(devino, "hd1", 'b', 3, 1);
	creat_file(devino, "hd2", 'b', 3, 2);
  creat_file(devino, "hd3", 'b', 3, 3);
	creat_file(devino, "hd4", 'b', 3, 4);
  creat_file(devino, "kmem", 'b', 1, 2);
	creat_file(devino, "lp", 'c', 6, 0);
  creat_file(devino, "mem", 'b', 1, 1);
	creat_file(devino, "null", 'b', 1, 3);
  creat_file(devino, "ram", 'b', 1, 0);
...
// #error "Bug: Upper directory count error."
    i = ialloc(S_IFDIR, 0, 0);
    memset(&de, 0, sizeof(struct dirent));
    de.inum = i;
